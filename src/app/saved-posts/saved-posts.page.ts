...
import { ModalController, MenuController,LoadingController, AlertController, Platform, IonContent, NavController } from '@ionic/angular'; 
...
export class SavedPostsPage implements OnInit {
  ...
  updateInfo(data){
	...
	getAllReccomdations(isFirstLoad, event){
	    ...
	    this.apiService.postData(dict,'getAllSavedRecc').subscribe((result) => {
